...
Public Class DPublicacion
    ...
    Public Sub Insertar(obj As Publicacion)
        Try
            ...
            comando.CommandType = CommandType.StoredProcedure
            comando.Parameters.Add("@id_publicacion", SqlDbType.Int).Value = obj.IdUsuario
            ...
            comando.Parameters.Add("@fecha_modificacion", SqlDbType.Structured).Value = obj.FechaModificacion
            MyBase.conn.Open()
